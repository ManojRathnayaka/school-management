    ...
    <Layout activePage="students">
      ...
      <div className="bg-base-100">
        <div className="card-body p-4 md:p-8">
          {/* Header */}
          <div className="mb-6">
            <h1 className="card-title text-2xl md:text-3xl text-base-content">
              <Users className="w-6 h-6 md:w-8 md:h-8 text-primary mr-2" />
              Students
            </h1>
          </div>
                  ...
                  <table className="table w-full">
                    <thead>
                      <tr className="bg-base-200">
                        ...
                        {/* Hidden on Mobile (Show on Medium+) */}
                        <th className="text-base-content font-semibold hidden md:table-cell">
                          <div className="flex items-center gap-2">
                        ...
                        {/* Hidden on Tablet/Mobile (Show on Large+) */}
                        <th className="text-base-content font-semibold hidden lg:table-cell">
                          <div className="flex items-center gap-2">
                        ...
                        {/* Always Visible */}
                        <th className="text-base-content font-semibold text-right">
                    ...
                    <tbody>
                      {students.map((student) => (
                        ...
                        >
                          ...
                          {/* Grade (Visible) */}
                          <td>
                            <div className="badge badge-outline badge-primary text-xs md:text-sm whitespace-nowrap">
                              {student.grade} - {student.section}
                            </div>
                          </td>

                          {/* Email (Hidden on Tablet/Mobile) */}
              ...
              {pagination.totalPages > 1 && (
                <div className="flex justify-center mt-6">
                  <div className="join">
                    ...
                    <button className="join-item btn btn-sm md:btn-md btn-primary">
