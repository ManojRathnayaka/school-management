...
export default function StudentRegistration() {
  ...
  const [registrationTab, setRegistrationTab] = useState("single"); // NEW STATE
    ...
    <Layout activePage="student-registration">
      <div className="bg-base-100">
        <div className="card-body">
          ...
          {/* NEW: Tabs for Single vs Bulk Registration */}
          <div className="tabs tabs-boxed mb-6 w-fit">
            <button
              className={`tab ${registrationTab === "single" ? "tab-active" : ""}`}
              onClick={() => setRegistrationTab("single")}
            >
              Single Registration
            </button>
            <button
              className={`tab ${registrationTab === "bulk" ? "tab-active" : ""}`}
          ...
          {/* Render appropriate form based on registrationTab */}
          {registrationTab === "single" ? (
            <>
              {/* Error Alert */}
              {error && (
