...
import { Search, Trash2, Edit, GraduationCap } from "lucide-react";
        ...
        <>
            ...
            {achievements.map((achievement) => (
              <div key={achievement.achievement_id} className="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="card-body p-4">
                  ...
                  <p className="font-semibold text-sm text-blue-600">{achievement.title}</p>
                  {achievement.details && (
          ...
          {achievements.length === 0 && (
            <div className="text-center py-12">
              <GraduationCap className="w-16 h-16 mx-auto text-base-content/30 mb-4" />
              <p className="text-base-content/50 text-lg">No academic achievements found.</p>
            </div>
          )}
