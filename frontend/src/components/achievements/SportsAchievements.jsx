...
import { Search, Trash2, Edit, Trophy } from "lucide-react";
        ...
        <>
            ...
            {achievements.map((achievement) => (
              <div key={achievement.achievement_id} className="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
                ...
                <div className="card-body p-4">
                  ...
                  <p className="font-semibold text-sm text-green-600">{achievement.title}</p>
                  {achievement.details && (
          ...
          {achievements.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-base-content/50 text-lg">No sports achievements found.</p>
            </div>
          )}
